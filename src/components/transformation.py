...
class TransformationConfig:
    preprocessor_obj_file=os.path.join("artifacts","preprocess.pkl")
...
class DataTransformation:
    ...
    def get_data_transform(self):
        try:
            ...
            logging.info("Numericl columns imputation and scaling is done")
            logging.info("categorical columns imputation, encoding and scaling is done")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("obtaining preprocessing data object")
            ...
            logging.info("preprocessing object saving")
            save_object (path=self.transformation_config.preprocessor_obj_file,obj=preprocessing_obj)

            return(
                train_arr,test_arr,self.transformation_config.preprocessor_obj_file
            )
        except Exception as e:
            raise CustomException(e,sys)
